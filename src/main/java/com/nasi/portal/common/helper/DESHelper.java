...
public class DESHelper {
	...
	private static String strDefaultKey = "anly";
	...
	public static DESHelper getInstance(String strKey) throws Exception {
		return new DESHelper(strKey);
	}
	 ...
	 * @throws Exception
	 */
    private DESHelper(String strKey) throws Exception {
